...
INSERT INTO `anuragironside` (`id`, `name`, `position`, `price`, `points`, `availability`) VALUES
(249, 'Iker Cassilas', 'GK', 6, 22, 'A/V'),
(252, 'Mason Mount', 'FWD', 13, 6, 'A/V'),
(253, 'Antonio Rudiger', 'DEF', 8, -1, 'A/V'),
(254, 'David Luiz', 'DEF', 2, 6, 'A/V'),
(255, 'Sergio Ramos', 'DEF', 2, 8, 'A/V'),
(256, 'Clint Dempsey', 'FWD', 10, 3, 'A/V'),
(257, 'Rio Ferdinand', 'DEF', 9, 0, 'A/V'),
(258, 'Aaron Ramsey', 'MID', 12, 0, 'A/V'),
(259, 'Pukki', 'FWD', 9, 0, 'A/V'),
(260, 'Kelvin Mirallas', 'MID', 10, 0, 'A/V'),
(261, 'Ngolo Kante', 'MID', 10, 0, 'A/V');
...
(4, 'Mason Mount scores 500th goal for chelsea at age of 27. He is a scary myth, Simply a legend!', 'anuragironside', 20),
(7, 'Congratulation to Chelsea FC for wining their 7th champions league under Manager Sir Frank James Lampard, One of the greatest midfielder to ever walk on the pitch and among one of the greater managers who has sat on the stand.\r\n#Rivalsnotenemies', 'Reddevilmanish', 19),
(11, 'Much respect to Cristiano but Messi is on whole new level', 'Anishcule', 28),
(13, 'Those who have eyes know that Lionel Messi compares to no none.', 'anuragironside', 22);
